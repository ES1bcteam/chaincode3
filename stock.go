...
// SimpleChaincode example simple Asset Management Chaincode implementation
...
// 在庫マスタ、取引テーブルを作成する
// 
func (t *TradeChaincode) Init(stub shim.ChaincodeStubInterface, function string, args []string) ([]byte, error) {
...
func (t *TradeChaincode) register(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
	if len(args) != 4 {
...
func (t *TradeChaincode) update(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
	if len(args) != 2 {
...
func (t *TradeChaincode) Query(stub shim.ChaincodeStubInterface, function string, args []string) ([]byte, error) {
	switch function {
...
func (t *TradeChaincode) order_entry(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
	if len(args) != 5 {
...
func (t *TradeChaincode) allocate_entry(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
...
func (t *TradeChaincode) shipment_entry(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
...
func (t *TradeChaincode) Invoke(stub shim.ChaincodeStubInterface, function string, args []string) ([]byte, error) {
